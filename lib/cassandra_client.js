...
var IPCClient = nodeIpcService.IPCClient;
...
module.exports = function (options) {
    ...
    var startCassandraServer = function (index, id) {
        var serviceId = id || 'cassandra-' + index;
        ...
        childPs.on('message', function (data) {
            ...
            switch (data.ac) {
                case MasterProcessActions.READY:
                    var cassClient = new IPCClient(serviceId);
                    cassClient.once('connected', function () {
                        toBarrier();
                    })
                    cassClient.once('disconnect', function () {
                        startCassandraServer(index, id);
                    })
