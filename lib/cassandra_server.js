...
if(process.env) {
    ...
    options.user = process.env.user || process.env.userName;
    options.password = process.env.password || process.env.pass;
    options.keyspace = process.env.keyspace;
    options.id = process.env.id;
}
